...
exports.getPractices = (req, resp, next) => {
  const url = "https://api.betterdoctor.com/2016-03-01/practices?location=37.773%2C-122.413%2C100&user_location=37.773%2C-122.413&fields=name%2Cuid&skip=0&limit=10&user_key=" + config.betterApiKey;
