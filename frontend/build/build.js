...
/***/ (function(module, exports, __webpack_require__) {
	...
	_vue2.default.http.headers.common['Authorization'] = 'JWT ' + localStorage.getItem('token');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "/Users/noahrinehart/Developer/DistHealth17/frontend/src/components/App.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var LOGIN_URL = API_URL + 'api/auth/login';
	var SIGNUP_URL = API_URL + 'api/auth/register';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/noahrinehart/Developer/DistHealth17/frontend/src/components/Home.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/noahrinehart/Developer/DistHealth17/frontend/src/components/Signup.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//     </div>
	//     <div class="radio">
	//       <label><input type="radio" id="provider" value="Provider" v-model="credentials.type">Provider</label>
	//     </div>
	//     <div class="radio">
	//       <label><input type="radio" id="patient" value="Patient" v-model="credentials.type">Patient</label>
	//     </div>
	//     <button class="btn btn-primary" type="submit" @click="submit()">Sign Up</button>
	//   </div>
	// </template>
	//
	// <script>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/noahrinehart/Developer/DistHealth17/frontend/src/components/Login.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/noahrinehart/Developer/DistHealth17/frontend/src/components/Application.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	//     </div>
	//     <div class="form-group">
	//       <input type="radio" name="marriage" id="Married" value="married" checked/>
	//       <label for="married">Married</label>
	//
	//       <input type="radio" name="editList" id="Not Married" value="not married"/>
	//       <label for="not married">Not Married</label>
	//     </div>
	//     <div class="form-group">
	//       <input type="radio" name="editList" id="Male" value="male" checked/>
	//       <label for="male">Male</label>
	//
	//       <input type="radio" name="editList" id="Female" value="female"/>
	...
	//         v-model="form.previousProviders"
	//       >
	//     </div>
	//     <div class="form-group">
	//       <input
	//         type="text"
	//         class="form-control"
	//         placeholder="List pre-existing conditions"
	//         v-model="credentials.password"
	//       >
	//     </div>
	//     <h1>...</h1>
	//     <button class="btn btn-primary" @click="submit()">Apply</button>
	//   </div>
	// </template>
	//
	// <script>
